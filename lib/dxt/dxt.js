...
exports.runBuild = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                buildx = "sudo " + tc.find('buildx', '0.3.0') + "/buildx";
                return [4 /*yield*/, core.group('buildx create', function () {
                        return exec.exec(buildx + " create --driver docker-container --use");
                    })];
            case 1:
                _a.sent();
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, core.group('Fetch QEMU', function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, exec.exec('sudo apt update')];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, exec.exec('sudo apt install -y qemu-user-static')];
                                case 2:
                                    _a.sent();
            ...
            case 3:
                _a.sent();
                _a.label = 4;
            case 4: return [4 /*yield*/, exports.runBuild(config)];
            case 5:
                _a.sent();
                return [2 /*return*/];
        }
