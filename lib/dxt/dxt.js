...
var defaultBuildArgs = function () { return __awaiter(void 0, void 0, void 0, function () {
    var gitCommit, gitBranch, buildTime;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, exec.exec('git rev-parse HEAD')];
            case 1:
                gitCommit = _a.sent();
            ...
            case 2:
                ...
                return [2 /*return*/, "--build-arg GIT_COMMIT=\"" + gitCommit + "\" --build-arg GIT_BRANCH=\"" + gitBranch + "\" --build-arg \"" + buildTime + "\""];
        }
    });
}); };
